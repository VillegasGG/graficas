...
df = pd.read_excel('compare_results_2_nodes.xlsx', sheet_name='gaps')
...
plt.title('Optimality Gap Distribution by Tree Size for instance set 1, k=2', fontsize=14, pad=15, fontweight='bold')
plt.xlabel('Tree Size (Number of Nodes)', fontsize=12, labelpad=10)
plt.ylabel('Optimality Gap (%)', fontsize=12, labelpad=10)

plt.tight_layout()
plt.savefig('boxplot_optimality_gap_2_nodes.png', dpi=300)
plt.show()